...
**DevOS** is a **Linux Live** operating system based on Fedora (RPM), developed as an **experimental project** to explore advances in artificial intelligence. This project is **80% developed by AI**, using Claude and ChatGPT as main models, showcasing what AI can achieve in complex software development.
...
The project took around **2 days of intense work**, dealing with limitations of free AI tools and constant technical challenges.
